...
public class Main {
    ...
    private void initializeFrame() {
        ...
        while(true){
            ...
            JOptionPane.showMessageDialog(disc, "Размер дискового раздела не удовлетворяет условию","Ошибка", JOptionPane.ERROR_MESSAGE);
        }
        ...
        while(true){
            ...
            JOptionPane.showMessageDialog(disc, "Размер сектора диска не удовлетворяет условию","Ошибка", JOptionPane.ERROR_MESSAGE);
        }
        ...
        disc.setPreferredSize(new Dimension(800, 800));
        ...
        buttonCopy.addActionListener(e -> {
            ...
            if (weightOfSelectedFolder <= disc.getCountOfEmptySectors()){
                ...
                JOptionPane.showMessageDialog(disc, "Недостаточно места","Ошибка", JOptionPane.ERROR_MESSAGE);
            }
            disc.repaint();
        });
        ...
        buttonCopyTo.addActionListener(e -> {
            ...
            if(selectedNode == newNode){
                JOptionPane.showMessageDialog(disc, "Нельзя копировать в одно и то же место","Ошибка", JOptionPane.ERROR_MESSAGE);
            } else {
        ...
        buttonReplaceInto.addActionListener(e -> {
            ...
            if(selectedNode == newNode){
                JOptionPane.showMessageDialog(disc, "Нельзя перемещать в одно и то же место","Ошибка", JOptionPane.ERROR_MESSAGE);
            } else {
